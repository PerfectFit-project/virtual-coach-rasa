...
FUTURE_SELF_INTRO = int(os.getenv('FUTURE_SELF_INTRO'))
GOAL_SETTING = int(os.getenv('GOAL_SETTING'))
# number of days after the weekly reflection for the PA notification to be sent
TIME_DELTA_PA_NOTIFICATION = int(os.getenv('TIME_DELTA_PA_NOTIFICATION'))
TRACKING_DURATION = int(os.getenv('TRACKING_DURATION'))
PREPARATION_GA = int(os.getenv('PREPARATION_GA'))
MAX_PREPARATION_DURATION = int(os.getenv('MAX_PREPARATION_DURATION'))
...
RESCHEDULE_DIALOG = 'celery_tasks.reschedule_dialog'
